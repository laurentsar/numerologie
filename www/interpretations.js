...
(function () {
  ...
  var expression = {
    1: "Vous vous montrez au monde en meneur : direct, autonome, capable de trancher. On vous confie volontiers les departs.",
    2: "Vous vous montrez conciliant et attentif. On vous cherche pour apaiser, relier, faire tenir un groupe ensemble.",
    3: "Vous vous montrez vivant et communicant. Votre aisance verbale et votre humour ouvrent les portes.",
    4: "Vous vous montrez fiable et methodique. On sait que ce que vous annoncez sera fait, dans les regles.",
    5: "Vous vous montrez adaptable et curieux. Vous changez de registre facilement et supportez mal l'enfermement.",
    6: "Vous vous montrez protecteur et disponible. On vient vers vous pour du conseil et du soutien.",
    7: "Vous vous montrez reserve et pointu. Vous parlez peu mais on ecoute quand vous parlez.",
    8: "Vous vous montrez sur de vous et efficace. Vous inspirez confiance dans les enjeux materiels.",
    9: "Vous vous montrez large d'esprit et genereux. Vous portez volontiers des causes qui vous depassent.",
    11: "Vous degagez quelque chose que l'on remarque sans savoir le nommer. Cela attire autant que cela intimide.",
    22: "Vous inspirez confiance a grande echelle : on vous suit sur des projets que d'autres jugeraient irrealistes.",
    33: "Vous rassurez. Votre presence a un effet apaisant, et l'on vous confie des choses importantes."
  };

  var intime = {
    1: "Au fond, vous voulez etre libre de vos decisions et reconnu pour ce que vous entreprenez.",
    2: "Au fond, vous cherchez la paix et un lien sur, ou l'on ne vous demande pas d'etre en representation.",
    3: "Au fond, vous voulez etre entendu et partager ce que vous ressentez, dans la legerete plutot que la lourdeur.",
    4: "Au fond, vous cherchez la securite : un cadre clair, des choses qui tiennent, peu d'imprevus.",
    5: "Au fond, vous voulez de l'espace. Toute promesse qui vous enferme vous fait fuir, meme quand vous l'avez souhaitee.",
    6: "Au fond, vous voulez que les vôtres aillent bien. Votre paix depend beaucoup de la leur.",
    7: "Au fond, vous cherchez a comprendre, et vous avez besoin de solitude pour cela. Ce n'est pas du rejet.",
    8: "Au fond, vous voulez peser sur le reel et ne plus jamais dependre de personne materiellement.",
    9: "Au fond, vous voulez que votre vie ait servi a quelque chose de plus large que vous.",
    11: "Au fond, vous aspirez a une justesse rare, et vous vous jugez durement quand vous ne l'atteignez pas.",
    22: "Au fond, vous voulez laisser une trace concrete, quelque chose qui continue sans vous.",
    33: "Au fond, vous voulez soulager. Le besoin d'etre utile aux autres est chez vous quasi structurel."
  };

  var realisation = {
    1: "Premiere impression : quelqu'un d'assure, qui sait ou il va. Parfois lu comme autoritaire.",
    2: "Premiere impression : quelqu'un de doux et abordable. Parfois lu comme hesitant.",
    3: "Premiere impression : quelqu'un d'agreable et vivant. Parfois lu comme peu serieux.",
    4: "Premiere impression : quelqu'un de solide et carre. Parfois lu comme rigide.",
    5: "Premiere impression : quelqu'un de vif et insaisissable. Parfois lu comme instable.",
    6: "Premiere impression : quelqu'un de chaleureux et fiable. Parfois lu comme envahissant.",
    7: "Premiere impression : quelqu'un de distant et profond. Parfois lu comme froid.",
    8: "Premiere impression : quelqu'un qui impose le respect. Parfois lu comme dur.",
    9: "Premiere impression : quelqu'un d'ouvert et bienveillant. Parfois lu comme insaisissable.",
    11: "Premiere impression : une presence qui ne laisse pas indifferent, difficile a situer.",
    22: "Premiere impression : quelqu'un de posé, dont on devine qu'il vise loin.",
    33: "Premiere impression : quelqu'un vers qui l'on va spontanement se confier."
  };
